package reflect.test.demo;
//https://blog.csdn.net/stonesing/article/details/52358288
/**
 * 博主感悟：博主认为使用反射机制的一些地方
 * 1.工厂模式：Factory 类中反射的话，添加了一个新的类之后，就不需要再修改工厂类Factory了
 * 2.数据库JDBC中通过Class.forName(Driver).来获得数据库连接驱动
 * 3.分析类文件：毕竟能得到类 中的方法等等
 * 4.访问一些不能访问的变量或属性：破解别人的代码
 * */
...
public class Main {
    ...
    {  
        ...
        class1 = Class.forName("reflect.test.demo.Person");  
  ...
  public static void Demo5() throws IllegalArgumentException, IllegalAccessException, SecurityException, NoSuchFieldException, InstantiationException, ClassNotFoundException  
   ...
   public static void Demo6() throws ClassNotFoundException  
     ...
     * @throws InstantiationException  
     */  
  /* public static void Demo7() throws NoSuchMethodException,ClassNotFoundException, 
   ...
   InstantiationException  
    ...
    {  
        Class<?> class1 = null;  
        class1 = Class.forName("reflect.test.demo.SuperMan");  
